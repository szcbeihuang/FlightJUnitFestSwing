...
public class HInputFlight extends JDialog implements ActionListener{
	...
	HInputFlight(JFrame jFrame,String strTitle)
	{
		...
		txtID.setName("txtIDFest");//为了JUnit Fest-swing的测试。
		...
		txtFname.setName("txtFnameFest");//为了JUnit Fest-swing的测试。
		...
		txtCompany.setName("txtCompanyFest");//为了JUnit Fest-swing的测试。
		...
		txtPrice.setName("txtPriceFest");//为了JUnit Fest-swing的测试。
		...
		txtSeat.setName("txtSeatFest");//为了JUnit Fest-swing的测试。
		...
		btnOK.setName("btnOKFest");//为了JUnit Fest-swing的测试。
